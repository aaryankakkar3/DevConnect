        ...
        <div className="relative">
          ...
          {sortDropdownOpen && (
            <div className="absolute right-0 top-full mt-1 bg-bg1 border border-text2 z-10">
              <SortDropDownButton forLabel="Newest First" forValue="newest" />
              <SortDropDownButton forLabel="Oldest First" forValue="oldest" />
              <SortDropDownButton
              ...
              <SortDropDownButton
                ...
                forValue="bids-high"
              />
              <SortDropDownButton forLabel="Lowest Bids" forValue="bids-low" />
            </div>
          )}
        </div>
      </div>
